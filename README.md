...
TODO:
    ...
    - [ ] implement state machine with in test, and in menu
        - [ ] in test: text in the middle of the screen. one button for reset test. One button for menu. graph for showing statistics.
            pressing menu button changes state and view to menu.
        - [ ] in menu: buttons for different modes. Buttons for settings. Buttons for statistics.
    - [ ] color scheme
    - [ ] store all typing commands in some datastructure so that the test can be replayed afterfards.
