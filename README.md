...
TODO:
- [x] draw current word in separate box refresh upon hitting space
- [x] fix mismatched draw queue and text buffer
- [x] create structs for different elements that can be resized based on terminal size.
